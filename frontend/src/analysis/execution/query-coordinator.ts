...
export async function executeAnalysis(input: { panelKey: string; sourceBody: string; query: AnalysisQueryRequestV1; capabilities: AnalysisCapabilities; functionBindings?: Array<{ alias: string; functionKey?: string; functionKind: import('../../types').AnalysisFunctionKind; sourceBody: string; options: Record<string, unknown> }> }) {
