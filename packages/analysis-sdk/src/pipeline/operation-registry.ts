...
export const pipelineOperationRegistry: readonly PipelineOperationDescriptor[] = Object.freeze([
  ...
  { methodName: 'map', inputType: 'NumericSeries', outputType: 'NumericSeries', rowCardinality: 'preserve', compatibleFunctionKinds: ['point-map'], deriveContext: none, editor: { label: 'Map', description: 'Transform each point without changing row count.', category: 'Functional' } },
